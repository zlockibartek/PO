...
class UserPanel
{
	...
	// 		case 'address':
	// 			ob_flush();
	// 			include $_SERVER['DOCUMENT_ROOT'] . '/wp-content/plugins/po/Views/user-data.view.php';
	// 			$html = ob_get_clean();
	// 			break;
	// 		case 'password':
	// 			ob_flush();
	...
	// 		default:
	// 			ob_flush();
	// 			include $_SERVER['DOCUMENT_ROOT'] . '/wp-content/plugins/po/Views/user-panel.view.php';
	// 			$html = ob_get_clean();
	// 			break;
	// 	}
	// 	echo $html;
